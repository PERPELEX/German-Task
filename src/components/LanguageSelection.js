...
export default function LanguageSelector() {
  ...
  return (
    <div className="relative group">
      ...
      <div className="absolute right-0 mt-2 w-48 rounded-xl overflow-hidden glass-card opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 z-50">
        <div className="py-2">
          {languages.map((lang) => (
            <button
              key={lang.code}
